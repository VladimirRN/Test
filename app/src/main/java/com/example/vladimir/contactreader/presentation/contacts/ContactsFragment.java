...
import com.example.vladimir.contactreader.presentation.adapters.CustomAdapter;
import com.example.vladimir.contactreader.utils.MyDecoration;
...
public class ContactsFragment extends MvpAppCompatFragment implements
        ContactsView, android.support.v7.widget.SearchView.OnQueryTextListener {


    @InjectPresenter
    ContactsPresenter contactPresenter;
    @Inject
    public Provider<ContactsPresenter> presenterProvider;
    @ProvidePresenter
    ContactsPresenter provideContactPresenter() {
